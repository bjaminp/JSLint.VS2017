...
{
    public sealed class ErrorListHelper : IServiceProvider, IDisposable
    {
        ...
        public ErrorListHelper(IServiceProvider serviceProvider)
        {
            ...
            _errorProvider = new ErrorListProvider(serviceProvider);//this implementing IServiceProvider
            _errorProvider.ProviderName = "JS Lint";
            _errorProvider.ProviderGuid = Guid.NewGuid();
            _errorProvider.Show();
        }
        ...
        public void OpenDocumentAndNavigateTo(string path, int line, int column)
        {
